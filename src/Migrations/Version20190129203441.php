 ...
 */
final class Version20190129203441 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE producto (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, tienda_id INTEGER NOT NULL, nombre VARCHAR(50) NOT NULL, descripcion VARCHAR(255) DEFAULT NULL, unidades INTEGER NOT NULL, precio INTEGER NOT NULL, created_at DATETIME NOT NULL)');
